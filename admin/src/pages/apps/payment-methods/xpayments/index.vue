...
const callbackUrlPreview = computed(
	() => settings.value.callbackUrl || apiBaseUrl + "/payment/xpayments/callback",
);
		...
		<VCard class="payment-method-shell">
			<VCardText class="payment-method-header">
				<div>
					...
					<h1 class="payment-method-title">XPayment</h1>
					<p class="payment-method-subtitle">
						XPayment H2H ödeme sağlayıcı ayarlarını yönetin.
					</p>
				</div>
				<VChip
				...
				<VContainer>
					...
					<VCard variant="outlined" class="mb-5">
						...
						<VCardText>
							<VRow>
								<VCol cols="12">
									<VSwitch v-model="settings.isActive" label="XPayment sağlayıcısını kullanıma aç" color="success" />
								</VCol>
								<VCol cols="12" md="6">
					...
					<VCard variant="outlined" class="mb-5">
						...
						<VCardText>
							<VRow>
								<VCol cols="12" sm="6">
									<VSwitch v-model="settings.methods.deposit" label="H2H yatırım" color="success" />
								</VCol>
								<VCol cols="12" sm="6">
									<VSwitch v-model="settings.methods.withdraw" label="IBAN çekim" color="warning" />
								</VCol>
							</VRow>
						</VCardText>
					</VCard>
					...
					<VCard variant="outlined">
						...
						<VCardText>
							<VRow>
								<VCol cols="12">
									<VTextField v-model="settings.apiUrl" label="API URL" placeholder="https://api.xpaymentsystems.com" />
								</VCol>
								<VCol cols="12" md="6">
