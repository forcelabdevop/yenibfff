...
// Load controllers
const { cashierRobuxInit } = require("../../controllers/cashier/robux");
const { cashierLimitedInit } = require("../../controllers/cashier/limited");
const { cashierCryptoInit } = require("../../controllers/cashier/crypto");
...
module.exports = (io) => {
  ...
  io.of("/cashier").on("connection", (socket) => {
    const identifier =
      socket.handshake.headers["cf-connecting-ip"] || socket.conn.remoteAddress;
